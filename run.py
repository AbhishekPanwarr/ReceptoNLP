...
from temp.profile_compare import get_embedding, VGG16ImageComparer, llm_validation, confidence_score
import os
from dotenv import load_dotenv
from agent.models import llm, embeddings
...
for persona in persona_json:
    ...
    linkedin_urls = search_profiles_from_json(search_persona, max_results=5)
